  ...
  return (
    <div className="min-h-screen pt-20 bg-black">
      ...
      <div className="max-w-md mx-auto px-4">
        ...
        <div className="bg-[#44443E] rounded-2xl p-6 md:p-8 border border-gray-800 shadow-lg">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-black border border-gray-800 rounded-lg px-3 py-2 pr-10 text-white focus:outline-none focus:border-soft-pink"
                  placeholder="••••••••"
          ...
          <div className="flex items-center my-6">
            <div className="flex-1 h-px bg-[#44443E]" />
          ...
          <div className="grid grid-cols-2 gap-3">
            <button onClick={handleGoogle} className="w-full px-3 py-2 rounded-lg bg-black text-white hover:bg-[#44443E] text-sm flex items-center justify-center space-x-2">
            ...
            <button className="w-full px-3 py-2 rounded-lg bg-black text-white hover:bg-[#44443E] text-sm flex items-center justify-center space-x-2">
          ...
          {googleUser && (
            <div className="mt-6 p-3 bg-[#44443E] rounded-lg text-sm text-gray-300">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-full bg-[#44443E] overflow-hidden">
                  {googleUser.photoURL ? (
          ...
          <p className="text-md text-soft-pink mt-6 text-center"><button type="button" onClick={() => setRegisterOpen(true)} className="hover:text-soft-pink">Register</button></p>
